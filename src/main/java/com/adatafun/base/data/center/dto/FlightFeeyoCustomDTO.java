 ...
 */
public class FlightFeeyoCustomDTO {
    ...
    private AlternateInfoDTO alternateInfo;
     ...
     * 计划起飞时间
     */
    @JSONField(format = "yyyy-MM-dd HH:mm:ss", name = "FlightDeptimePlanDate")
    private Date depScheduledDate;

    /**
     * 预计起飞时间
     */
    @JSONField(format = "yyyy-MM-dd HH:mm:ss", name = "FlightDeptimeReadyDate")
    private Date depEstimatedDate;

    /**
     * 实际起飞时间
     */
    @JSONField(format = "yyyy-MM-dd HH:mm:ss", name = "FlightDeptimeDate")
     ...
     * 计划起飞时间
     */
    @JSONField(format = "yyyy-MM-dd HH:mm:ss", name = "FlightArrtimePlanDate")
    private Date arrScheduledDate;

    /**
     * 预计起飞时间
     */
    @JSONField(format = "yyyy-MM-dd HH:mm:ss", name = "FlightArrtimeReadyDate")
    private Date arrEstimatedDate;
    /**
     * 实际起飞时间
     */
    @JSONField(format = "yyyy-MM-dd HH:mm:ss", name = "FlightArrtimeDate")
    ...
    public AlternateInfoDTO getAlternateInfo() {
        return alternateInfo;
    }

    public void setAlternateInfo(AlternateInfoDTO alternateInfo) {
